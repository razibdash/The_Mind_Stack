...
export async function fetchStudentsViewCourseListService(query) {
  const { data } = await axiosInstance.get(`/api/student/course/get?${query}`);

  return data;
}
export async function fetchStudentsViewCourseDetailsService(id) {
  const { data } = await axiosInstance.get(`/api/student/course/get/details/${id}`);
...
export async function checkCoursePurchaseInfoService(courseId, studentId) {
  const { data } = await axiosInstance.get(
    `api/student/course/purchase-info/${courseId}/${studentId}`
  );
  return data;
}
...
export async function fetchStudentBoughtCoursesService(studentId) {
  const { data } = await axiosInstance.get(
    `api/student/courses-bought/get/${studentId}`
  );
